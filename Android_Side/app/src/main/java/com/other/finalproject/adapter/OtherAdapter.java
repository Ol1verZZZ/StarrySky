 ...
 * desc:
 */
public class OtherAdapter extends BaseQuickAdapter<ResourceBean.OthersBean, BaseViewHolder> {
    ...
    @Override
    protected void convert(BaseViewHolder helper, ResourceBean.OthersBean item) {
