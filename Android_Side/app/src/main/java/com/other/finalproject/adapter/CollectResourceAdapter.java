 ...
 * desc:
 */
public class CollectResourceAdapter extends BaseQuickAdapter<CollectResourceBean.ResourcesBean, BaseViewHolder> {

    public CollectResourceAdapter() {
        super(R.layout.resource_item);
    }

    @Override
    protected void convert(BaseViewHolder helper, CollectResourceBean.ResourcesBean item) {
