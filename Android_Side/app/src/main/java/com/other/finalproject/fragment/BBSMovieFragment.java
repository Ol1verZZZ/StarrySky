 ...
 * desc: 影视
 */
public class BBSMovieFragment extends BaseFragment {
    ...
    public static BBSMovieFragment newInstance() {
        return new BBSMovieFragment();
    }
    ...
    public int getLayoutResId() {
        return R.layout.bbs_movice_fragment;
    }
    ...
    public void initDatas() {
        OkGo.<String>get(Constant.baseUrl + "forum/homepage?username=" + SpUtil.getData("userName") + "&posttype=movie&ranktype=time")
