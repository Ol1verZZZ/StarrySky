...
public class BBSAllFragment extends BaseFragment {
    ...
    public static BBSAllFragment newInstance() {
        return new BBSAllFragment();
    }
    ...
    public int getLayoutResId() {
        return R.layout.bbs_all_fragment;
    }
    ...
    public void initDatas() {
        OkGo.<String>get(Constant.baseUrl + "forum/homepage?username=" + SpUtil.getData("userName") + "&posttype=all&ranktype=time")
