 ...
 * desc:
 */
public class GamesAdapter extends BaseQuickAdapter<ResourceBean.GamesBean, BaseViewHolder> {
    ...
    @Override
    protected void convert(BaseViewHolder helper, ResourceBean.GamesBean item) {
