 ...
 * desc: 其他
 */
public class BBSOtherFragment extends BaseFragment {
    ...
    public static BBSOtherFragment newInstance() {
        return new BBSOtherFragment();
    }
    ...
    public int getLayoutResId() {
        return R.layout.bbs_other_fragment;
    }
    ...
    public void initDatas() {
        OkGo.<String>get(Constant.baseUrl + "forum/homepage?username=" + SpUtil.getData("userName") + "&posttype=other&ranktype=time")
